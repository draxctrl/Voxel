...
class SplashScreen(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        # Hotkey hint
        import platform
        _hotkey_hint = "Cmd + Shift + Space to dictate" if platform.system() == "Darwin" else "Ctrl + Shift + Space to dictate"
        hint = QLabel(_hotkey_hint)
        hint.setFont(QFont("SF Mono", 9))

...
class SettingsWindow(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        coffee_label.setObjectName("subtitle")
        coffee_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        coffee_label.setOpenExternalLinks(True)
        root_layout.addWidget(coffee_label)

        built_label = QLabel("Built with <3 by Drax")
        built_label.setStyleSheet("color: #444444; font-size: 10px;")
        built_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        root_layout.addWidget(built_label)
